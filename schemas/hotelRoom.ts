...
const hotelRoom = {
    ...
    fields: [
        ...
        defineField({
            ...
            title: 'Price',
            type: 'number',
            validation: Rule => Rule.required().min(100).error('Minimum 100 Rupees'),
        }),
        defineField({
            name: 'discount',
            title: 'Discount',
        ...
        defineField({
            ...
            type: 'text', 
            validation: Rule=> Rule.required(),
            initialValue: 'Check in time is 12:00 PM, checkout time is 11:59 AM. If you leave behind any items, please contact the Receiptionist.',
        }),
        defineField({
            name: 'dimension', 
            title: 'Dimension', 
