            ...
            <div className="container mx-auto mt-20">
                <div className="md:grid md:grid-cols-12 gap-10 px-3">
                    <div className="md:col-span-8 md:w-full">
                        <div>
                            ...
                            <div className="md-11">
                                ...
                                {room.offeredAmenities.map(amenity =>(
                                <div key={amenity._key} className="flex item-center md:my-0 my-1">
                                    <i className={`fa-solid ${amenity.icon} md:text-2xl`}></i>
                                    <p className="text-xs md:text-base ml-2 mb-2 pb-1">{amenity.amenity}</p>
                                </div>))}
                                </div>
                            </div>
                            <div className="mb-11">
                    ...
                    <div className="md:col-span-4 rounded-xl shadow-lg dark:shadow dark:shadow-white sticky top-10 h-fit overflow-auto">
                        ...
                        adults={adults} noOfChildren={noOfChildren}
                        setAdults={setAdults} setNoOfChildren={setNoOfChildren} isBooked={room.isBooked} handleBookNowClick={handleBookNowClick}/>
                    </div>
                </div>
            </div>
        </div>
